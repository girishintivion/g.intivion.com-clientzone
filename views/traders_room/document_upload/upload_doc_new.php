...
?>
    ...
    <div class="main-content-wrap white-bg">
      <div class="upload-section paddingbottom2x">
        <div class="spacebottom2x">
          ...
          <?php echo form_open_multipart('document-upload/test',array('method'=>'post','id'=>'uploadform1','class'=>'form-horizontal clearfix'));?>
    ...
    <h4 class="lt">loading</h4>
      ...
      <div class="upload-section paddingtop2x paddingbottom2x">
        <div class="spacebottom2x">
         ...
         <?php echo form_open_multipart('document-upload/test',array('method'=>'post','id'=>'uploadform2','class'=>'form-horizontal clearfix'));?>
    ...
    <h4 class="lt">loading</h4>
        ...
        <div class="spacebottom2x">
          ...
          <?php echo form_open_multipart('document-upload/test',array('method'=>'post','id'=>'uploadform3','class'=>'form-horizontal clearfix'));?>
      ...
      <div class="upload-section paddingtop2x">
        <div class="spacebottom2x">
          <div class="common-table pagination-tbl">
            ...
            ?>
                  <td><a href="<?php echo $get_file;?>" download><?php echo wordwrap($row->original_filename,35,"<br>\n",True);?></a></td>
