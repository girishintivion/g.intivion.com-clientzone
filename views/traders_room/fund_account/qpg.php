...
?>
    ...
    <h1 class="lg-heading">Deposit Funds Using QUBEPAY</h1>
    <div class="row clearfix">
      <div class="col-md-9 col-sm-12 col-xs-12">
        ...
        <form class="form-horizontal clearfix" id="fundformcashier" method="post" action="">
             
       
            
                      <?php 	            
            $token = md5(uniqid(rand(), TRUE));            
            if(isset ($_SESSION['form_token_cashier']))
            {
            	unset($_SESSION['form_token_cashier']);
            }            
			$_SESSION['form_token_cashier'] = $token;	
			?>
            <input type="hidden" name="my_token_cashier" value="<?php echo $token;?>">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="col-xs-12">
                <div class="btn-box spacetop1x text-right">
                  <button type="submit" class="btn-login" name="submit" id="cashier_submit">Submit</button>
         ...
         messages:{
        	 acc: { required: '<?php echo lang('This field is required.'); ?>' },
         	 ...
         	 amount: {
 	                ...
 	                IsAmount: "<?php echo ('Minimum deposit amount is 50'); ?>",
 	            },
