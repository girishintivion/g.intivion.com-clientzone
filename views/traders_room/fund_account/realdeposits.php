         ...
         <?php // echo form_open('deposit',array('class'=>'form-horizontal clearfix','id'=>'fundform','method'=>'post')); */?>        
            ...
            ?>
			               ...
			               <!-- <div class="clearfix"></div>
			  			  ...
			  			  <div>Deposit Amount - Minimum 1,000 Maximum 1,500</div> 
						  </div> -->
			  ...
			  <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-suitcase" aria-hidden="true"></i></span>
                    <input type="text" class="form-control" placeholder="<?php echo ('Street'); ?>" name="address" id="address" value="<?php echo $result[0]->address1; ?>" >
                  </div>
                </div>
              </div>
			  ...
			  <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-suitcase" aria-hidden="true"></i></span>
                    <input type="text" class="form-control" placeholder="<?php echo ('Province'); ?>" name="state" id="state" value="<?php echo $result[0]->state; ?>" >
                  </div>
                </div>
              </div>
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-credit-card-alt" aria-hidden="true"></i></span>
                    <input type="text" class="form-control" placeholder="<?php echo lang('CVV'); ?>" name="cvv" id="cvv_fund"   maxlength="20" >
                  </div>
                </div>
              </div>
              <div class="clearfix"></div>
              ...
              <div class="col-xs-12">
                <div class="btn-box spacetop1x text-right">
                  <button type="submit" class="btn-login" name="submit" id="deposit_submit">Submit</button>
...
/*
	 ...
	 // if(value<1000 || value>1500)
   	...
   	}, "Minimum amount is 250 and Maximum amount is 1000");
         ...
         messages:{
        	...
        	/* 
         	 amount: {
					 ...
					 IsAmount: "Minimum amount is 250 and Maximum amount is 1000",
 	            },
