...
?>
    ...
    <h1 class="lg-heading">Deposit Funds using CERTUS</h1>
    <div class="row clearfix">
      <div class="col-md-9 col-sm-12 col-xs-12">
        ...
        <form class="form-horizontal clearfix" id="fundformcashier22" method="post" action="">
             
       
            
                      <?php 	            
            $token = md5(uniqid(rand(), TRUE));            
            if(isset ($_SESSION['form_token_cashier22']))
            {
            	unset($_SESSION['form_token_cashier22']);
            }            
			$_SESSION['form_token_cashier22'] = $token;	
			?>
            <input type="hidden" name="my_token_cashier22" value="<?php echo $token;?>">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="col-xs-12">
                <div class="btn-box spacetop1x text-right">
                  <button type="submit" class="btn-login" name="submit" id="cashier22_submit">Submit</button>
...
$(document).ready(function(){
 	...
 	$.validator.addMethod("IsAmount", function(value, element) {
	  ...
	  if(value<500 || value>1000)
   	...
   	}, "Minimum deposit amount is 500 and Maximum deposit amount is 1000");
  	

	    
     $("#fundformcashier22").validate({
         rules: {
        	 acc: { required: true },       	 
        	 amount: {
  	                required: true,
         ...
         messages:{
        	 acc: { required: '<?php echo lang('This field is required.'); ?>' },       	 
         	 amount: {
 	                ...
 	                IsAmount: "<?php echo ('Minimum deposit amount is 500 and Maximum deposit amount is 1000'); ?>",
 	            },
